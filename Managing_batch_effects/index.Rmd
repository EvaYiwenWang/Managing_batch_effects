...
4. Log-ratio transformation with Centered Log Ratio (CLR)          
...
**Note:** We need to add an offset of 1 to all count data to handle zeroes for the CLR transformation. As the sponge data were already TSS scaled, a small offset is added in this specific case. However, we recommend starting from the raw count (not TSS) for those analyses. 
...
We then check the library size that sums to 1 for each sample for the AD and HD data. 
