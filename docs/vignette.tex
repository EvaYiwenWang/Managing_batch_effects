...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-50-2.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-55-1.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-3.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-4.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-5.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-6.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-7.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-8.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-9.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-10.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-11.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-12.pdf}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-59-13.pdf}
...
\CommentTok{# RUVIII}
\CommentTok{# conditioning on a batch effect}
\NormalTok{rda.ad.ruv1 =}\StringTok{ }\KeywordTok{rda}\NormalTok{(ad.ruvIII }\OperatorTok{~}\StringTok{ }\NormalTok{group }\OperatorTok{+}\StringTok{ }\KeywordTok{Condition}\NormalTok{(batch), }\DataTypeTok{data =}\NormalTok{ data.design.ad)}
\NormalTok{rda.ad.ruv2 =}\StringTok{ }\KeywordTok{rda}\NormalTok{(ad.ruvIII }\OperatorTok{~}\StringTok{ }\NormalTok{batch }\OperatorTok{+}\StringTok{ }\KeywordTok{Condition}\NormalTok{(group), }\DataTypeTok{data =}\NormalTok{ data.design.ad)}
...
\NormalTok{eset.X.ruv <-}\StringTok{ }\KeywordTok{new}\NormalTok{(}\StringTok{"ExpressionSet"}\NormalTok{, }\DataTypeTok{exprs =} \KeywordTok{t}\NormalTok{(ad.ruvIII), }\DataTypeTok{phenoData =}\NormalTok{ pdata)}
...
\NormalTok{############}
\CommentTok{# AD data}
\NormalTok{silh.ad.before =}\StringTok{ }\KeywordTok{calc.sil}\NormalTok{(ad.pca.before}\OperatorTok{$}\NormalTok{variates}\OperatorTok{$}\NormalTok{X,}\DataTypeTok{y1 =}\NormalTok{ ad.batch, }\DataTypeTok{y2=}\NormalTok{ ad.trt, }\DataTypeTok{name.y1 =} \StringTok{'Batch'}\NormalTok{,}\DataTypeTok{name.y2 =} \StringTok{'Treatment'}\NormalTok{)}
\NormalTok{silh.ad.bmc =}\StringTok{ }\KeywordTok{calc.sil}\NormalTok{(ad.pca.bmc}\OperatorTok{$}\NormalTok{variates}\OperatorTok{$}\NormalTok{X,}\DataTypeTok{y1 =}\NormalTok{ ad.batch, }\DataTypeTok{y2=}\NormalTok{ ad.trt, }\DataTypeTok{name.y1 =} \StringTok{'Batch'}\NormalTok{,}\DataTypeTok{name.y2 =} \StringTok{'Treatment'}\NormalTok{)}
\NormalTok{silh.ad.combat =}\StringTok{ }\KeywordTok{calc.sil}\NormalTok{(ad.pca.combat}\OperatorTok{$}\NormalTok{variates}\OperatorTok{$}\NormalTok{X,}\DataTypeTok{y1 =}\NormalTok{ ad.batch, }\DataTypeTok{y2=}\NormalTok{ ad.trt, }\DataTypeTok{name.y1 =} \StringTok{'Batch'}\NormalTok{,}\DataTypeTok{name.y2 =} \StringTok{'Treatment'}\NormalTok{)}
\NormalTok{silh.ad.limma =}\StringTok{ }\KeywordTok{calc.sil}\NormalTok{(ad.pca.limma}\OperatorTok{$}\NormalTok{variates}\OperatorTok{$}\NormalTok{X,}\DataTypeTok{y1 =}\NormalTok{ ad.batch, }\DataTypeTok{y2=}\NormalTok{ ad.trt, }\DataTypeTok{name.y1 =} \StringTok{'Batch'}\NormalTok{,}\DataTypeTok{name.y2 =} \StringTok{'Treatment'}\NormalTok{)}
\NormalTok{silh.ad.percentile =}\StringTok{ }\KeywordTok{calc.sil}\NormalTok{(ad.pca.percentile}\OperatorTok{$}\NormalTok{variates}\OperatorTok{$}\NormalTok{X,}\DataTypeTok{y1 =}\NormalTok{ ad.batch, }\DataTypeTok{y2=}\NormalTok{ ad.trt, }\DataTypeTok{name.y1 =} \StringTok{'Batch'}\NormalTok{,}\DataTypeTok{name.y2 =} \StringTok{'Treatment'}\NormalTok{)}
\NormalTok{silh.ad.svd =}\StringTok{ }\KeywordTok{calc.sil}\NormalTok{(ad.pca.svd}\OperatorTok{$}\NormalTok{variates}\OperatorTok{$}\NormalTok{X,}\DataTypeTok{y1 =}\NormalTok{ ad.batch, }\DataTypeTok{y2=}\NormalTok{ ad.trt, }\DataTypeTok{name.y1 =} \StringTok{'Batch'}\NormalTok{,}\DataTypeTok{name.y2 =} \StringTok{'Treatment'}\NormalTok{)}
\NormalTok{silh.ad.ruv =}\StringTok{ }\KeywordTok{calc.sil}\NormalTok{(ad.pca.ruv}\OperatorTok{$}\NormalTok{variates}\OperatorTok{$}\NormalTok{X,}\DataTypeTok{y1 =}\NormalTok{ ad.batch, }\DataTypeTok{y2=}\NormalTok{ ad.trt, }\DataTypeTok{name.y1 =} \StringTok{'Batch'}\NormalTok{,}\DataTypeTok{name.y2 =} \StringTok{'Treatment'}\NormalTok{)}
...
\includegraphics{vignette_files/figure-latex/unnamed-chunk-67-2.pdf}
